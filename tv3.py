...
dpg.create_context()
dpg.create_viewport(title=_program_title, width=900, height=500)

#####    main  box #######
##########################
        
with dpg.window(label="Mainbox", width=400, height=400,tag="Mainbox"):       
...
with dpg.window(label="Child_box", show=True, id="child_box",
                no_title_bar=False,tag="child_box",pos=[470,30],width=400,height=280):
    ...
    with dpg.group(horizontal=True):
        dpg.add_input_text(label="ABCDEF" ,tag="input1",width=130, callback=setkb)
