...
def on_row_selected(sender, app_data, user_data):
    ...
    def show_window():
        ...
        dpg.delete_item("New_Window_popup") if dpg.does_item_exist("New_Window_popup") else None
        with dpg.window(label="New_Window_popup", tag="New_Window_popup", pos=(x, y+21)):
...
dpg.create_context()
dpg.create_viewport(title="CSV Viewer (Dear PyGui)", width=1200, height=600)
...
with dpg.window(label="Testing Sequence", show=True, id="right_click_menu", no_title_bar=False,tag="popup_window",pos=[900,100],width=500,height=100):
    dpg.add_text("GLX-KLAtestlist", tag="my_text")
